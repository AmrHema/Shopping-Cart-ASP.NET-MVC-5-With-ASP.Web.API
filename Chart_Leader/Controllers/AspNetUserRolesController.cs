...
namespace Chart_Leader.Controllers
{
    public class AspNetUserRolesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,RoleId,Notes")] AspNetUserRoles aspNetUserRoles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,RoleId,Notes")] AspNetUserRoles aspNetUserRoles)
        {
            if (ModelState.IsValid)
            {
